...
const publicRoutes = [
	...
	{
		path: "/ProductPages/DustCollector",
		component: DustCollector,
		Layout: HeaderOnly,
	},
	...
	//order pages
	{
		path: "/OrderPages/Cau_Hoi_Thuong_Gap",
		component: Cau_Hoi_Thuong_Gap,
		Layout: HeaderOnly,
	},
	{
		path: "/OrderPages/Gioi_Thieu_May_Doi_Tra",
		component: Gioi_Thieu_May_Doi_Tra,
		Layout: HeaderOnly,
	},
	{
		path: "/OrderPages/Gioi_Thieu_Ve_Cong_Ty",
		component: Gioi_Thieu_Ve_Cong_Ty,
		Layout: HeaderOnly,
	},
	{
		path: "/OrderPages/Huong_Dan_Mua_Hang_Va_Thanh_Toan_Online",
		component: Huong_Dan_Mua_Hang_Va_Thanh_Toan_Online,
		Layout: HeaderOnly,
	},
	{
		path: "/OrderPages/Quy_Che_Hoat_Dong",
		component: Quy_Che_Hoat_Dong,
		Layout: HeaderOnly,
	},

	//policy pages
	{
		path: "/Policy/Chinh_Sach_Bao_Hanh",
		component: Chinh_Sach_Bao_Hanh,
		Layout: HeaderOnly,
	},
	{
		path: "/Policy/Chinh_Sach_Doi_Tra",
		component: Chinh_Sach_Doi_Tra,
		Layout: HeaderOnly,
	},
	{
		path: "/Policy/Chinh_Sach_Bao_Mat",
		component: Chinh_Sach_Bao_Mat,
		Layout: HeaderOnly,
	},
	{
		path: "/Policy/Chinh_Sach_Tra_Gop",
		component: Chinh_Sach_Tra_Gop,
		Layout: HeaderOnly,
	},
	{
		path: "/Policy/Chinh_Sach_Khui_Hop_San_Pham",
		component: Chinh_Sach_Khui_Hop_San_Pham,
		Layout: HeaderOnly,
	},
	{
		path: "/Policy/Chinh_Sach_Thu_Thap_Va_Xu_Ly_Du_Lieu_Ca_Nhan",
		component: Chinh_Sach_Thu_Thap_Va_Xu_Ly_Du_Lieu_Ca_Nhan,
		Layout: HeaderOnly,
	},
	{
		path: "/Policy/Chinh_Sach_Giao_Hang_Va_Lap_Dat",
		component: Chinh_Sach_Giao_Hang_Va_Lap_Dat,
		Layout: HeaderOnly,
	},
	{
		path: "/Policy/Quy_Dinh_Ve_Ho_Tro_Ky_Thuat_Va_Sao_Luu_Du_Lieu",
		component: Quy_Dinh_Ve_Ho_Tro_Ky_Thuat_Va_Sao_Luu_Du_Lieu,
		Layout: HeaderOnly,
	},
];
