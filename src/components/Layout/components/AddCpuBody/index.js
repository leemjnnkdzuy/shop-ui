    ...
    return (
        <div className={cx("wrapper")}>
            <form onSubmit={handleSubmit}>
                ...
                {/* CPU-specific fields */}
                <input type="text" name="SocketType" placeholder="Socket Type" onChange={handleChange} />
                <input type="number" name="Cores" placeholder="Cores" onChange={handleChange} />
                <input type="number" name="Threads" placeholder="Threads" onChange={handleChange} />
                <input type="number" name="BaseClock" placeholder="Base Clock (GHz)" step="0.1" onChange={handleChange} />
                <input type="number" name="BoostClock" placeholder="Boost Clock (GHz)" step="0.1" onChange={handleChange} />
                ...
                <input type="text" name="IntegratedGraphics" placeholder="Integrated Graphics" onChange={handleChange} />
                <input type="text" name="Architecture" placeholder="Architecture" onChange={handleChange} />
                <input type="text" name="ManufacturingProcess" placeholder="Manufacturing Process" onChange={handleChange} />
                <input type="text" name="MemorySupport" placeholder="Memory Support" onChange={handleChange} />
                <input type="text" name="MaxMemoryBandwidth" placeholder="Max Memory Bandwidth" onChange={handleChange} />
                <input type="text" name="MaximumMemory" placeholder="Maximum Memory" onChange={handleChange} />
                <input type="number" name="PCIeLanes" placeholder="PCIe Lanes" onChange={handleChange} />
                <input type="text" name="VirtualizationSupport" placeholder="Virtualization Support" onChange={handleChange} />
                <input type="text" name="ThermalInterfaceMaterial" placeholder="Thermal Interface Material" onChange={handleChange} />
                <input type="number" name="PowerConsumption" placeholder="Power Consumption (W)" onChange={handleChange} />
