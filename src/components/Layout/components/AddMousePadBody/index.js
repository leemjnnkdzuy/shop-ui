...
import styles from "./AddMousePadBody.module.scss";
import Popup from "~/components/Layout/components/Popup";

const cx = classNames.bind(styles);

const AddMousePadBody = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await request.post("api/mousePadItem", data, {
            ...
            if (response.status === 201) {
                setSuccessMessage("Mouse Pad added successfully");
                setShowPopup(true);
                clearForm();
    ...
    return (
        <div className={cx("wrapper")}>
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" name="Thickness" placeholder="Thickness" onChange={handleChange} />
                <input type="text" name="SurfaceType" placeholder="Surface Type" onChange={handleChange} />
                <input type="text" name="AntiSlip" placeholder="Anti Slip" onChange={handleChange} />
                ...
                <button type="submit">Add Mouse Pad</button>
            </form>
...
export default AddMousePadBody;
