...
import styles from "./AddEarphoneBody.module.scss";
import Popup from "~/components/Layout/components/Popup";

const cx = classNames.bind(styles);

const AddEarphoneBody = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await request.post("api/earphoneItem", data, {
				headers: {
		...
		<div className={cx("wrapper")}>
			<form onSubmit={handleSubmit}>
				...
				<input
					type="text"
					name="EarTipMaterial"
					placeholder="Ear Tip Material"
					onChange={handleChange}
				/>
				<input
					type="text"
					name="AdjustableCable"
					placeholder="Adjustable Cable"
					onChange={handleChange}
				/>
				<input
					type="text"
				...
				<button type="submit">Add Earphone</button>
			</form>
...
export default AddEarphoneBody;
