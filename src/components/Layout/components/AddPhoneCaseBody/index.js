...
import styles from "./AddPhoneCaseBody.module.scss";
import Popup from "~/components/Layout/components/Popup";

const cx = classNames.bind(styles);

const AddPhoneCaseBody = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await request.post("api/phoneCaseItem", data, {
				headers: {
		...
		<div className={cx("wrapper")}>
			<form onSubmit={handleSubmit}>
				...
				<input
					type="text"
					name="DropTestRating"
					placeholder="Drop Test Rating"
					onChange={handleChange}
				/>
				<button type="submit">Add Phone Case</button>
			</form>
...
export default AddPhoneCaseBody;
