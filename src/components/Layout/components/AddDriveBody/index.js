...
import styles from "./AddDriveBody.module.scss";
...
const AddDriveBody = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await request.post("api/driveItem", data, {
				headers: {
		...
		<div className={cx("wrapper")}>
			<form onSubmit={handleSubmit}>
				...
				<input
					type="text"
					name="Type"
					placeholder="Drive Type (SSD/HDD)"
					onChange={handleChange}
				/>
				<input
					type="text"
