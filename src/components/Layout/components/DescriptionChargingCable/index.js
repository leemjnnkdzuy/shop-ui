...
function DescriptionChargingCable({ items, showFullDescription }) {
    ...
    const specifications = {
        ...
        technical: {
            ...
            compatibility: { value: Array.isArray(items.Compatibility) ? items.Compatibility.join(', ') : items.Compatibility },
        },
        physical: {
                        ...
                        <div className={cx("double-description-box")}>
                            <div className={cx("description-box")}>
                                <div className={cx("content-description-box")}>
                                    ...
                                    <div className={cx("content-box")}>{getValue(specifications.basic.cableType)}</div>
                                </div>
                            ...
                            <div className={cx("description-box")}>
                                <div className={cx("content-description-box")}>
                                    ...
                                    <div className={cx("content-box")}>{getValue(specifications.basic.connectorType)}</div>
                                </div>
                                <div className={cx("icon-description-box")}>
                        ...
                        <div className={cx("double-description-box")}>
                            ...
                            <div className={cx("description-box")}>
                                <div className={cx("content-description-box")}>
                                    ...
                                    <div className={cx("content-box")}>{getValue(specifications.basic.maximumPower)}</div>
                                </div>
                                <div className={cx("icon-description-box")}>
                        ...
                        <div className={cx("information-description")}>
                            <div className={cx("description-box")}>
                                <div className={cx("content-description-box")}>
                                    ...
                                    <div className={cx("content-box")}>{getValue(specifications.technical.dataTransferRate)}</div>
                                </div>
                                <div className={cx("icon-description-box")}>
                            ...
                            <div className={cx("description-box")}>
                                <div className={cx("content-description-box")}>
                                    ...
                                    <div className={cx("content-box")}>{getValue(specifications.technical.compatibility)}</div>
                                </div>
                                <div className={cx("icon-description-box")}>
                        ...
                        <div className={cx("information-description")}>
                            ...
                            <div className={cx("description-box")}>
                                <div className={cx("content-description-box")}>
                                    ...
                                    <div className={cx("content-box")}>{getValue(specifications.physical.durability)}</div>
                                </div>
                                <div className={cx("icon-description-box")}>
