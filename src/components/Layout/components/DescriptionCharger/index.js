                            ...
                            <div className={cx("double-description-box")}>
                                <div className={cx("description-box")}>
                                    <div className={cx("content-description-box")}>
                                        ...
                                        <div className={cx("content-box")}>{getValue(specifications.powerSpecs.output)}</div>
                                    </div>
                                    <div className={cx("icon-description-box")}>
                                ...
                                <div className={cx("description-box")}>
                                    <div className={cx("content-description-box")}>
                                        ...
                                        <div className={cx("content-box")}>{getValue(specifications.powerSpecs.ports)}</div>
                                    </div>
                                    <div className={cx("icon-description-box")}>
                            ...
                            <div className={cx("double-description-box")}>
                                <div className={cx("description-box")}>
                                    <div className={cx("content-description-box")}>
                                        ...
                                        <div className={cx("content-box")}>{getValue(specifications.powerSpecs.connector)}</div>
                                    </div>
                                    <div className={cx("icon-description-box")}>
                                ...
                                <div className={cx("description-box")}>
                                    <div className={cx("content-description-box")}>
                                        ...
                                        <div className={cx("content-box")}>{getValue(specifications.powerSpecs.cable)}</div>
                                    </div>
                                    <div className={cx("icon-description-box")}>
                            ...
                            <div className={cx("double-description-box")}>
                                <div className={cx("description-box")}>
                                    <div className={cx("content-description-box")}>
                                        ...
                                        <div className={cx("content-box")}>{getValue(specifications.powerSpecs.fastCharging)}</div>
                                    </div>
                                    <div className={cx("icon-description-box")}>
                            ...
                            <div className={cx("double-description-box")}>
                                ...
                                <div className={cx("description-box")}>
                                    <div className={cx("content-description-box")}>
                                        ...
                                        <div className={cx("content-box")}>{getValue(specifications.features.safety)}</div>
                                    </div>
                                    <div className={cx("icon-description-box")}>
